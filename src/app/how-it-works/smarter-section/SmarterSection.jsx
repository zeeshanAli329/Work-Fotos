        ...
        <div className="px-[24px]  ">
          ...
          <section className="flex flex-col lg:flex-row md:flex-row  justify-center items-center gap-15 md:px-[64px] ">
            ...
            {card.map((items, index) => (
              <div className="flex flex-wrap justify-start items-start font-inter mt-8 lg:mt-10 transition-all duration-300 ease-in-out hover:scale-101 rounded-lg shadow-md bg-[#ffffff]"
              key={index}
              >
                <div className="md:w-[222px] md:h-[138px] lg:w-[292px] lg:h-[187px]  w-[210px] h-[140px] py-[16px] px-[12px]  md:px-[29px]  flex flex-col justify-start items-start gap-5">
