    ...
    <section className="lg:px-[100px] md:px-[64px] px-[24px] lg:mt-20 max-w-[1452px] justify-center flex mx-auto flex-col">
      ...
      >
        ...
        <div className="flex flex-col gap-5 md:gap-7 lg:gap-8 text-white md:w-[60%]">
          <h1
            className="font-inter font-semibold text-[28px] leading-[110%]
          ...
          <p
            className="font-inter font-normal text-[15px] leading-[140%] opacity-90
          ...
          <Link
            ...
            w-[180px] h-[50px] rounded-[12px] bg-white text-[#0C4DF4] font-semibold 
